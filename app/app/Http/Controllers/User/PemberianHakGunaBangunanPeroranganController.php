...
class PemberianHakGunaBangunanPeroranganController extends Controller
{
    public function index()
    {
        return view('user.pemberian_hak_guna_bangunan_perorangan.index');
    }

    public function create()
    {
        return view('user.pemberian_hak_guna_bangunan_perorangan.form_pendaftaran');
    }
    ...
    public function printPdf(Request $request)
    {
        ...
        $template = new TemplateProcessor(public_path('word-template/pemberian-hak-guna-bangunan-perorangan/formulir_tanah_negara.docx'));
        ...
        $path = 'test/pemberian-hak-guna-bangunan-perorangan/';
        ...
        $file = "./test/pemberian-hak-guna-bangunan-perorangan/formulir_tanah_negara.pdf";
