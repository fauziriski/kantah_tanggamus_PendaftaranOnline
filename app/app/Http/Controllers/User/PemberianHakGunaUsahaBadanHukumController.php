...
class PemberianHakGunaUsahaBadanHukumController extends Controller
{
    public function index()
    {
        return view('user.pemberian_hak_guna_usaha_badan_hukum.index');
    }

    public function create()
    {
        return view('user.pemberian_hak_guna_usaha_badan_hukum.form_pendaftaran');
    }
    ...
    public function printPdf(Request $request)
    {
        ...
        $template = new TemplateProcessor(public_path('word-template/pemberian-hak-guna-usaha-badan-hukum/formulir_tanah_negara.docx'));
        ...
        $path = 'test/pemberian-hak-guna-usaha-badan-hukum/';
        ...
        $file = "./test/pemberian-hak-guna-usaha-badan-hukum/formulir_tanah_negara.pdf";
