...
class TukarMenukarController extends Controller
{
    ...
    {
        $template = new TemplateProcessor(public_path('word-template/tukar-menukar/pendaftaran_tukar_menukar.docx'));
        ...
        $path = 'test/tukar-menukar/';
        $saveDocPath = public_path($path . 'pendaftaran_tukar_menukar.docx');
        $template->saveAs($saveDocPath);

        //Save it into PDF
        $savePdfPath = public_path($path . 'pendaftaran_tukar_menukar.pdf');
        ...
        $file = "./test/tukar-menukar/pendaftaran_tukar_menukar.pdf";
