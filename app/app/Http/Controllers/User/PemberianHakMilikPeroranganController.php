...
class PemberianHakMilikPeroranganController extends Controller
{
    public function index()
    {
        return view('user.pemberian_hak_milik_perorangan.index');
    }

    public function create()
    {
        return view('user.pemberian_hak_milik_perorangan.form_pendaftaran');
    }
    ...
    public function printPdf(Request $request)
    {
        ...
        $template = new TemplateProcessor(public_path('word-template/pemberian-hak-milik-perorangan/formulir_tanah_negara.docx'));
        ...
        $path = 'test/pemberian-hak-milik-perorangan/';
        ...
        $file = "./test/pemberian-hak-milik-perorangan/formulir_tanah_negara.pdf";
