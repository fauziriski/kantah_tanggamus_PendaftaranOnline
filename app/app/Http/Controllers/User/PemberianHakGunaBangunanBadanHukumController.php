...
class PemberianHakGunaBangunanBadanHukumController extends Controller
{

    public function index()
    {
        return view('user.pemberian_hak_guna_bangunan_badan_hukum.index');
    }

    public function create()
    {
        return view('user.pemberian_hak_guna_bangunan_badan_hukum.form_pendaftaran');
    }
    ...
    public function printPdf(Request $request)
    {
        ...
        $template = new TemplateProcessor(public_path('word-template/pemberian-hak-guna-bangunan-badan-hukum/formulir_tanah_negara.docx'));
        ...
        $path = 'test/pemberian-hak-guna-bangunan-badan-hukum/';
        ...
        $file = "./test/pemberian-hak-guna-bangunan-badan-hukum/formulir_tanah_negara.pdf";
