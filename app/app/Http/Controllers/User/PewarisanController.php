...
class PewarisanController extends Controller
{
    ...
    {
        $template = new TemplateProcessor(public_path('word-template/pewarisan/pendaftaran_pewarisan.docx'));
        ...
        $path = 'test/pewarisan/';
        $saveDocPath = public_path($path . 'pendaftaran_pewarisan.docx');
        $template->saveAs($saveDocPath);

        //Save it into PDF
        $savePdfPath = public_path($path . 'pendaftaran_pewarisan.pdf');
        ...
        $file = "./test/pewarisan/pendaftaran_pewarisan.pdf";
