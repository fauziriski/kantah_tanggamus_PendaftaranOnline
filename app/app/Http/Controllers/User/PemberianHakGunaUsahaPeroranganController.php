...
class PemberianHakGunaUsahaPeroranganController extends Controller
{
    public function index()
    {
        return view('user.pemberian_hak_guna_usaha_perorangan.index');
    }

    public function create()
    {
        return view('user.pemberian_hak_guna_usaha_perorangan.form_pendaftaran');
    }
    ...
    public function printPdf(Request $request)
    {
        ...
        $template = new TemplateProcessor(public_path('word-template/pemberian-hak-guna-usaha-perorangan/formulir_tanah_negara.docx'));
        ...
        $path = 'test/pemberian-hak-guna-usaha-perorangan/';
        ...
        $file = "./test/pemberian-hak-guna-usaha-perorangan/formulir_tanah_negara.pdf";
