...
@section('title', 'Pembaruan Hak Pakai Instansi/Badan Usaha Pemerintah')
@section('content')
    <div class="body">
        <div style="color:black; font-size:12pt;">
            ...
            <ol class="text-justify padding-right">
                ...
                <li>Fotokopi KTP dan para pihak penjual-pembeli dan atau kuasanya.</li>
        ...
        <div style="color:black; font-size:12pt;">
            ...
            <ol>
                <li><a href="" target="_blank" class="btn btn-info" role="button">Formulir Pendaftaran Pembaruan Hak
