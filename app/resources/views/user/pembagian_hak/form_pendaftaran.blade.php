                ...
                <div class="row">
                    <div class="col-12">
                        <div class="title my-0">
                            <h3><b>Pendaftaran Peralihan Hak - Pembagian Hak Bersama</b></h3>
                        </div>
                    </div>
                </div>
                <form action="/pembagian-hak-bersama/printPdf" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-xl-9 col-lg-9 col-md-6 col-sm-12 col-12">
                            Perihal : <u>Pendaftaran Peralihan Hak - Pembagian Hak Bersama</u>
                        </div>
