...
@section('title', 'Pembagian Hak Bersama')
@section('content')
    <div class="body">
        <div style="color:black; font-size:12pt;">
            ...
            <ol class="text-justify padding-right">
                ...
                <li>Akta Pembagian Hak Bersama dari PPAT</li>
        ...
        <div style="color:black; font-size:12pt;">
            ...
            <ol>
                <li><a href="" target="_blank" class="btn btn-info" role="button">Formulir Pendaftaran Peralihan
                        Jual Beli</a></li>
