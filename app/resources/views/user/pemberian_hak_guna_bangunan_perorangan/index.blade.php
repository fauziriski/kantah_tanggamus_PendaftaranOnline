...
@section('title', 'Pemberian Hak Guna Bangunan Perorangan')
@section('content')
    ...
    <div class="body">
        <div style="color:black; font-size:12pt;">
            ...
            <ol class="text-justify padding-right">
                ...
                <li>Proposal rencana penggunaan dan pemanfaatan tanah.</li>
            ...
            <div class="padding" style="padding-left: 0px;">
                <ol class="text-justify padding-right">
                    <li>38 hari untuk luasan tidak lebih dari 2.000 M2.</li>
                    <li>57 hari untuk luasan lebih dari 2.000 M2 s/d 150.00 M2.</li>
        ...
        <div style="color:black; font-size:12pt;">
            ...
            <ol>
                <li><a href="{{ route('pemberian_hak_guna_bangunan_perorangan.form_pendaftaran') }}" target="_blank"
                        class="btn btn-info" role="button">Formulir Pendaftaran Pemberian Hak
                        Guna Bangunan Perorangan</a></li>
