...
@section('title', 'Penggantian Sertifikat Karena Rusak')
@section('content')
    <div class="body">
        ...
        <div style="color:black; font-size:12pt;">
            ...
            <ol>
                <li><a href="{{ route('penggantian_sertifikat_karena_rusak.form_pendaftaran') }}" target="_blank"
                        class="btn btn-info" role="button">Formulir Pendaftaran Penggantian
                        Sertifikat Karena Rusak</a></li>
