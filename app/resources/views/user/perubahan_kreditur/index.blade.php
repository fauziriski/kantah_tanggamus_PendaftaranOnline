...
@section('title', 'Perubahan Kreditur')
@section('content')
    <div class="body">
        <div style="color:black; font-size:12pt;">
            ...
            <ol class="text-justify padding-right">
                ...
                <li>APHT (Akta Pemberian Hak Tanggungan).</li>
        ...
        <div style="color:black; font-size:12pt;">
            ...
            <ol>
                <li><a href="{{ route('perubahan_kreditur.form_pendaftaran') }}" target="_blank" class="btn btn-info "
                        role="button">Formulir Pendaftaran Perubahan
                        Kreditur</a></li>
