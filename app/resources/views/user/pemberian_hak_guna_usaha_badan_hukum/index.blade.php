...
@section('title', 'Pemberian Hak Guna Usaha Badan Hubum')
@section('content')
    <div class="body">
        ...
        <div style="color:black; font-size:12pt;">
            ...
            <ol>
                <li><a href="{{ route('pemberian_hak_guna_usaha_badan_hukum.form_pendaftaran') }}" target="_blank"
                        class="btn btn-info" role="button">Formulir Pendaftaran Pemberian Hak Guna Usaha Badan Hukum</a>
                </li>
