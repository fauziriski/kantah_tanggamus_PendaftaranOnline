...
@section('title', 'Pemberian Hak Guna Usaha Perorangan')
@section('content')
    <div class="body">
        ...
        <div style="color:black; font-size:12pt;">
            ...
            <ol>
                <li><a href="{{ route('pemberian_hak_guna_usaha_perorangan.form_pendaftaran') }}" target="_blank"
                        class="btn btn-info" role="button">Formulir Pendaftaran Pemberian Hak
                        Guna Usaha Perorangan</a></li>
