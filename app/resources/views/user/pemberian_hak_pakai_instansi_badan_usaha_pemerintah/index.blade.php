...
@section('title', 'Pemberian Hak Pakai Instansi/Badan Usaha Pemerintah')
    ...
    <div class="body">
        <div style="color:black; font-size:12pt;">
            ...
            <ol class="text-justify padding-right">
                ...
                <li>Penetapan Lokasi atau Surat Ijin Penunjukan Penggunaan Tanah.</li>
                <li>Bukti perolehan tanah atau alas hak atau surat pernyataan dari pengelola aset.</li>
        ...
        <div style="color:black; font-size:12pt;">
            ...
            <ol>
                <li><a href="" target="_blank" class="btn btn-info" role="button">Formulir Pendaftaran Pemberian Hak
                        Pakai Instansi/Badan Usaha Pemerintah</a></li>
