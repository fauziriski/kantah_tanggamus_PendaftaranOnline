                ...
                <div class="row">
                    <div class="col-12">
                        <div class="title my-0">
                            <h3><b>Pendaftaran Peralihan Hak - Ganti Nama</b></h3>
                        </div>
                    </div>
                </div>
                <form action="/jual-beli/printPdf" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-xl-9 col-lg-9 col-md-6 col-sm-12 col-12">
                            Perihal : <u>Pendaftaran Peralihan Hak - Ganti Nama</u>
                        </div>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" name="sk59" type="checkbox"
                                                        value="SK. 59 dari KANWIL BPN DKI">
                                                    SK. 59 dari KANWIL BPN DKI
                                                    <span class="form-check-sign">
                                                        <span class="check"></span>
                                                    </span>
                                                </label>
