    ...
    <div class="body">
        <div style="color:black; font-size:12pt;">
            ...
            <ol class="text-justify padding-right">
                ...
                <li>Surat Permintaan dari Pengadilan, Kejaksaan, Kepolisian, Komisi Pemberantasan Korupsi, Kantor Pelayanan
                    Pajak, atau Kantor Lelang.</li>
                <li>Berita Acara Penetapan Sita Jaminan dari Pengadilan.</li>
            </ol><br />
