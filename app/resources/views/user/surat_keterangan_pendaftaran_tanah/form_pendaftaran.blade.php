                ...
                <div class="row">
                    <div class="col-12">
                        <div class="title my-0">
                            <h3><b>Permohonan Untuk SKPT</b></h3>
                        </div>
                    </div>
                </div>
                <form action="permohonan_untuk_skpt_pdf.php" method="post">
						<div class="row">
							<div class="col-xl-9 col-lg-9 col-md-6 col-sm-12 col-12">
								Perihal : <u>Permohonan Untuk SKPT</u>
							</div>
							...
							<div class="col-12">
								...
								<input type="text" class="form-control" name="dipergunakanuntuk"><br>
								Sebagai kelengkapan bahan-bahan permohonan, bersama ini dilampirkan:
								<input type="text" class="form-control" placeholder="1." name="lampiran1">
								<input type="text" class="form-control" placeholder="2." name="lampiran2">
								<input type="text" class="form-control" placeholder="3." name="lampiran3">
								<input type="text" class="form-control" placeholder="4." name="lampiran4">
								<input type="text" class="form-control" placeholder="5." name="lampiran5"><br>
